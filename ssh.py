...
def ssh(robot_ip: str, action: str):
    """Do the work."""
    ...
    ssh_client.connect(hostname=robot_ip, username="root", pkey=pkey, disabled_algorithms=disabled_algorithms)
...
if __name__ == "__main__":
    ...
    ssh(robot_ip=robot_ip, action=action)
